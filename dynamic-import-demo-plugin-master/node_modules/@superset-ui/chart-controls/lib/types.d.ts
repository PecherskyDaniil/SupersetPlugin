 ...
 */
export declare type ExtraControlProps = AnyDict;
 ...
 *    be visibile.
 */
export interface BaseControlConfig<T extends ControlType = ControlType, O extends SelectOption = SelectOption, V = unknown> extends AnyDict {
    type: T;
    label?: ReactNode;
    ...
    warning?: ReactNode;
    error?: ReactNode;
    mapStateToProps?: (state: ControlPanelState, control: this, actions?: ControlPanelActionDispatchers) => ExtraControlProps;
 ...
 * --------------------------------------------- */
declare type SelectOption = AnyDict | string | [ReactText, ReactNode];
declare type SelectControlType = 'SelectControl' | 'SelectAsyncControl' | 'MetricsControl' | 'FixedOrMetricControl' | 'AdhocFilterControl' | 'FilterBoxItemControl' | 'MetricsControlVerifiedOptions' | 'SelectControlVerifiedOptions' | 'AdhocFilterControlVerifiedOptions';
