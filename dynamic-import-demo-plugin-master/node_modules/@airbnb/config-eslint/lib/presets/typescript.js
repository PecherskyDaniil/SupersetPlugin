...
const project = nimbus_common_1.fromRoot('tsconfig.eslint.json', true) || nimbus_common_1.fromRoot('tsconfig.json');
const config = {
    settings: {
        'import/parsers': {
    ...
    overrides: [
        {
            ...
            rules: {
                ...
                'import/no-extraneous-dependencies': [
                    ...
                    {
                        devDependencies: [
                            `test/**/*.${nimbus_common_1.EXTS_GROUP}`,
                            `tests/**/*.${nimbus_common_1.EXTS_GROUP}`,
                            `**/*.test.${nimbus_common_1.EXTS_GROUP}`,
                            `**/jest.config.${nimbus_common_1.EXTS_GROUP}`,
                            `**/webpack.config.${nimbus_common_1.EXTS_GROUP}`,
                            `**/webpack.config.*.${nimbus_common_1.EXTS_GROUP}`,
                        ],
